Yml генератор на php, старая версия, php5
============

Это старая версия генератора, рассчитанная на PHP 5.\*, она не развивается 10.07.2019. Новая версия лежит [здесь](https://github.com/notdest/yandex-yml-generator).
